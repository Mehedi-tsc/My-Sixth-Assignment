...
const ToggleSection = ({setActiveBtn}) => {
    return (
        <div>
             <div className='mb-10 text-center space-y-4'>
                ...
                <div className="tabs tabs-box justify-center items-center bg-transparent">
                    ...
                    <input onClick={()=>setActiveBtn('carts')} type="radio" name="my_tabs_1" className="tab w-40 rounded-full font-bold checked:bg-blue-500 checked:text-white" aria-label="Cart (2)"/>
                </div>
            </div>
        </div>
    );
